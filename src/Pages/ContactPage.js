...
function ContactPage() {
    return (
        <div>
            <div className="title">
                <Tittle title="About Goashta" span="About Goashta"  />
            </div>
            <div className="ContactPage">
                ...
                <div className="contact-sect">
                    <ContactItem icon={phone} text1={'+91 7756110718'} text2={'+0333 6782 8792'} title={'Phone'}/>
                    <ContactItem icon={email} text1={'team@goashta.shop'} text2={'goashtateam@gmail.com'} title={'Email'}/>
